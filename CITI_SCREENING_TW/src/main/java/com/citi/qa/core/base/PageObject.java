...
import com.citi.qa.reports.utils.BaseHTMLReporter;
    ...
    extends TestListenerAdapter
{
    ...
    protected PageObject()
    {
        ...
        this.wait = new WebDriverWait( webDriver, PageObject.DRIVER_WAIT_TIME );
    }

    @BeforeMethod
    public void setUp( final ITestContext context )
    {
        context.setAttribute( BaseHTMLReporter.DRIVER_ATTRIBUTE, webDriver );
    }
    ...
    {
        return new WebDriverWait( WebDriverHelper.getWebDriver(), PageObject.DRIVER_WAIT_TIME ).until(
    ...
    public WebElement waitForExpectedElement( final By by, long waitTimeInSeconds )
    {
        ...
        {
            PageObject.LOG.info( e.getMessage() );
            return null;
        }
        ...
        throws NoSuchElementException
    {
        return driver -> {
            ...
            {
                PageObject.LOG.error( e.getMessage() );
            }
    ...
    {
        return new WebDriverWait( WebDriverHelper.getWebDriver(), PageObject.DRIVER_WAIT_TIME ).until(
                ExpectedConditions.elementSelectionStateToBe( by, selected ) );
    }

    public void waitForAlert()
    {
        new WebDriverWait( WebDriverHelper.getWebDriver(), PageObject.DRIVER_WAIT_TIME ).until(
    ...
    public boolean isElementPresent( final By by )
    {
        ...
        {
            PageObject.LOG.info( exception.getMessage() );
            return false;
        }
        return true;
    }
